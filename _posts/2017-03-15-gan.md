...
used Adam, we also added dropout at the middle of training.

We also used feature matching which really helped the generator learn better
reconstruction features.

In the BEGAN framework, the discriminator is an autoencoder and the objective 
is also a minimax game, but where the generator tries to minimize the 
...
- Adding a reconstruction L2 loss to the generator helped stabilize training a lot, but
 resulted in square artefacts 
